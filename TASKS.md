...
- [x] Fixed E2E smoke gate (added SUPABASE_STAGING_SERVICE_KEY + SMOKE_TEST_* fallback to e2e.yml and global-setup). Supports pre-created user when signups disabled. User to create account + GH secrets.
