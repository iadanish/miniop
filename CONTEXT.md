...
- 219 code scanning alerts (31 crit/high) mitigated via python:3.12-slim, purge perl, .trivyignore, filters, torch 2.6.0. Not all fixed (base). See DECISIONS. Latest d7c01a1.
