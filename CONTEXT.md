...
- 219 code scanning alerts (31 crit/high) mitigated via python:3.12-slim, Docker upgrades, .trivyignore, filters, torch update. Not all fixed (base image). See DECISIONS.
